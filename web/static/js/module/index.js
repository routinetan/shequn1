...
function navContent() {    //分类导航
    ...
    nav += '			</li>';
    nav += '		</a>';
    nav += '		<a href="http://www.haobangyingxiaocehua.cn/app/index.php?i=2&c=entry&act=index&do=user.sys_case&m=lywywl_ztb">';
    nav += '			<li>';
    nav += '				<img src="https://www.haobangyingxiaocehua.cn/attachment/images/2/2020/12/Bw4uU1OszFS6ZAsOXuS1C1nU6wsWEF.jpg"/>';
    nav += '				<p>营销工具</p>';
    nav += '			</li>';
    nav += '		</a>';
    nav += '		<a href="https://www.haobangyingxiaocehua.cn/app/index.php?i=2&c=entry&do=index&m=nan_fc&state=1">';
    nav += '			<li>';
    nav += '				<img src="https://www.haobangyingxiaocehua.cn/attachment/images/2/2020/12/wwzZgUk6w6YsGwyZuEu96oY6UUY76y.jpg"/>';
    nav += '				<p>娱乐游戏</p>';
    nav += '			</li>';
    nav += '		</a>';
    nav += '		<a href="https://www.haobangyingxiaocehua.cn/./index.php?i=2&c=entry&do=index&m=small_poster&id=19">';
    nav += '			<li>';
    nav += '				<img src="https://www.haobangyingxiaocehua.cn/attachment/images/2/2020/12/LfpCiSuimO85ZwSc1C5SIJWQUsUSIF.jpg"/>';
    nav += '				<p>微信商城</p>';
    nav += '			</li>';
    nav += '		</a>';
    nav += '		<a href="https://www.haobangyingxiaocehua.cn/./index.php?i=2&c=entry&do=index&m=small_poster&id=18">';
    nav += '			<li>';
...
function qunSumContent() {    //群统计
    ...
    qunSum += '	<div class="buyvip"><a href="./index.php?i=2&c=entry&do=vipContent&m=yy_shequn2"> 点击购买VIP,拉您进20个社群并尊享会员特权 &gt</a></div>';
